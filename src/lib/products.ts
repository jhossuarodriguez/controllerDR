...
export const colorSwatches: Record<string, string> = {
  White: "#ffffff",
  "Midnight Black": "linear-gradient(135deg, #09090A 0%, #111113 60%, #222226 100%)",
  "Cosmic Red": "#c91832",
  "Starlight Blue": "#8fb7e8",
  "Galactic Purple": "#5d4b8c",
  "Chroma Indigo": "linear-gradient(135deg, #1A0B5E 0%, #3F00FF 35%, #6900C6 70%, #9A00E6 100%)",
  "Chroma Pearl": "linear-gradient(135deg, #FDFBF7 0%, #EAE5D9 40%, #E3E9E2 75%, #F5E6EC 100%)",
  "Chroma Teal": "linear-gradient(135deg, #004B49 0%, #008080 35%, #00A3A3 70%, #76FFD4 100%)",
  "Cobalt Blue": "linear-gradient(135deg, #001F54 0%, #0047AB 50%, #0074E4 100%)",
  "Remix Green": "linear-gradient(180deg, #111113 0%, #111113 45%, #9dcb36 45%, #9dcb36 100%)",
  "Rhythm Blue": "linear-gradient(180deg, #111113 0%, #111113 45%, #00A2E8 45%, #00A2E8 100%)",
  "Sterling Silver": "#98a2b4",
  "Tecno Red": "linear-gradient(180deg, #111113 0%, #111113 45%, #e31a35 45%, #e31a35 100%)",
};
...
export const products: Product[] = [
  {
    ...
    description:
      "Factory-sealed PS5 controller for players who want the original Sony feel, fast local coordination, and full console compatibility.",
  ...
  },
  {
    ...
    description:
      "Rotating DualSense colors for players who want their setup to look different without compromising original Sony performance.",
    features: [
      "Original Sony hardware",
  ...
  },
  {
    ...
    description:
      "A pro-level wireless controller with deeper customization for competitive players and premium PlayStation setups.",
    features: [
      "Remappable inputs",
  ...
  },
  {
    ...
    description:
      "A collector-focused DualSense drop for PlayStation fans who want a special-edition controller when stock reaches the Dominican Republic.",
    features: [
      "Limited-edition design",
      "Collector-friendly packaging",
      "Original DualSense features",
      "Availability confirmed by request",
    ],
